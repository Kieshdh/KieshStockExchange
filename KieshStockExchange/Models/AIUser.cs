...
public class AIUser : User
{
    ...
    public bool AiIsValid() => 
        UserId > 0 && MinAmountStocks >= 0 && MaxAmountStocks >= MinAmountStocks &&
        OnlinePercentage >= 0 && OnlinePercentage <= 1 && Aggressiveness >= 0 && 
        Aggressiveness <= 1 && Balance >= 0 && WatchlistStocks != null && IsValid();
}
