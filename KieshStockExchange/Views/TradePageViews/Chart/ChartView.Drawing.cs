...
public partial class ChartView
{
    ...
    private void DragDrawing(PointF p)
    {
        ...
        DrawingObject upd = _draggingDrawingPart switch
        {
            ...
            // Text/Comment/PriceLabel/Crossline are single-anchor — a body-drag moves the whole anchor.
            _ when d.Kind == DrawTool.Text || d.Kind == DrawTool.Comment
                || d.Kind == DrawTool.PriceLabel || d.Kind == DrawTool.Crossline
