...
namespace KieshStockExchange.Server.Data.Migrations
{
    ...
    [Migration("20260720202712_AddAdminTableTimeIndexes")]
    partial class AddAdminTableTimeIndexes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KieshStockExchange.Services.DataServices.Persistence.CandleRow", b =>
                {
                    ...
                    b.Property<double?>("MoodMid")
                        .HasColumnType("double precision");

                    b.Property<double?>("MoodSlow")
                        .HasColumnType("double precision");
            ...
            modelBuilder.Entity("KieshStockExchange.Services.DataServices.Persistence.OrderRow", b =>
                {
                    ...
                    b.HasIndex("UserId", "StockId", "Side")
            ...
            modelBuilder.Entity("KieshStockExchange.Services.DataServices.Persistence.UserDrawingRow", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("UserId", "StockId", "Currency")
                        .IsUnique()
                        .HasDatabaseName("IX_UserDrawing_Key");

                    b.ToTable("UserDrawings", (string)null);
                });
