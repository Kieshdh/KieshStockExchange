...
- **★ DRIFT oscillating ~0 (stable, on-target):** @07:17 6h drift **−0.0023** (minor noise; p25/p75 −0.0100/**+0.0051** = centered ~0, NOT the shifted-down @05:51 distribution; 24h was +0.0056 @06:34). ret_acf VWAP **−0.041** (noisy, neg/in-band). Moves VERY calm (45m p95 0.53%/max 1.78%, zero >5%/>3%; 3h zero >3%, p99 0.82%). CK=0. ⇒ HOLD. (Prior cycle: 24h reverted +0.0056 positive = the @05:51 neg-tilt was a transient; log-sym correctly NOT armed. Re-trigger only on STABLE 24h<0 across 2 cycles.)
