...
- **★ CLEAN DRIFT + ret_acf — §1 ON-TARGET, drift oscillating ~0 (2 consec-neg WATCH):** @04:28 drift 6h **−0.0044** (2 consec marginal-neg; trend +0.0002→−0.0001→−0.0044, tiny −0.4% inside ±1% p25/p75 −0.010/+0.003 = noise). ret_acf VWAP **−0.046** (noisy up-tick from −0.105; still neg/in-band, 1 pt=noise). Moves VERY calm (45m p95 0.34%/max 1.51%, zero >5%/>3%; 3h zero >3%, p99 0.71%). CK=0. ⇒ HOLD; if 3rd consec-neg next cycle ⇒ arm log-sym A/B.
