...
- **★ DRIFT oscillating ~0 (stable, on-target):** @12:40 prod 6h drift **−0.0009** (flat; p25/p75 −0.0119/+0.0016). ret_acf VWAP **−0.116** (on §1 target). Moves VERY calm (45m p95 0.33%/max 1.07%, zero >5%/>3%; 3h zero >3%). CK=0. ⇒ HOLD.
