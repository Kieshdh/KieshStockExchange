...
- **★ CLEAN DRIFT + ret_acf — §1 ON-TARGET, drift oscillating ~0:** @03:48 drift 6h **−0.0001** (flat noise; trend −0.0006→+0.0002→−0.0001, 1 marginal consec-neg;
  p25/p75 −0.005/+0.008). ret_acf VWAP **−0.105** (on §1 −0.1 target). Moves VERY calm (45m p95 0.36%/max 2.74%, zero >5%/>3%; 3h zero >3%, p99 0.63%). CK=0. ⇒ HOLD, no trigger.
